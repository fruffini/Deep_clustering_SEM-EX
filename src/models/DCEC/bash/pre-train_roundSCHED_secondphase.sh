...
python train.py --id_exp ID${ID} --phase pretrain --embedded_dimension=${emb} --dataset_name=${dataset} --n_epochs=50 --n_epochs_decay=50 --AE_type=${arch} --save_latest_freq=5000 --gpu_ids=${str_ids} --verbose --box_apply --dataset_name=${dataset} --data_dir=${dat} --config_dir=${cof} --reports_dir=${rep}
