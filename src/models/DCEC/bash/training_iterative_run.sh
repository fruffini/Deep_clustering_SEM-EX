...
python train.py --phase train --k_0=4 ----k_fin=24 --delta_check --delta_label=0.0003 --data_dir '/mimer/NOBACKUP/groups/snic2022-5-277/ltronchin/data' --config_dir '/mimer/NOBACKUP/groups/snic2022-5-277/fruffini/SEM-EX/configs' --reports_dir '/mimer/NOBACKUP/groups/snic2022-5-277/fruffini/SEM-EX/reports' --embedded_dimension=256 --dataset_name CLARO --AE_type CAE512 --n_epochs=500 --n_epochs_decay=500 --save_latest_freq=20000 --gpu_ids '0,1,2,3'
